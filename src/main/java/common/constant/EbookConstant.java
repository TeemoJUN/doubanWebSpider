...
public class EbookConstant {
     ...
     * 抽取eBook中书名
     */
    public static final String TITLE_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/h1/text()";

    /**
     * 抽取eBook中子标题
     */
    public static final String SUBTITLE_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/p/text()";

    /**
     * 抽取eBook中的作者
     */
    public static final String AUTHOR_NAME_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[1]/span[2]/a/text()";

    /**
     * 抽取eBook中的译者，
     * @TODO 等待后期用正则表达式抽取文字 "<a[^>]*>([^<]*)</a>"
     */
    public static final String TRANSLATOR_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[2]/span[2]";

    /**
     * 抽取eBook中的书籍类别
     */
    public static final String LABEL_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[3]/span[2]/span/text()";

    /**
     * 抽取eBook中的书籍出版社
     */
    public static final String PRESS_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[4]/span[2]/span[1]/text()";
