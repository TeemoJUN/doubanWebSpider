...
public class EbookConstant {
     ...
     * 抽取eBook中的书籍出版社
     */
    public static final String PRESS_XPATH = "/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[@class!='category']/span[2]/span[1]/text()";

    /**
     * 抽取eBook中的书籍出版日期
     */
    public static final String PUBTIME_XPATH="/html/body/div/div[2]/article/div[1]/div[2]/div[1]/p[@class!='category']/span[2]/span[2]/text()";
