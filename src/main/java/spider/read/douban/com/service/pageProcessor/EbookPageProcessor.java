    ...
    public  void createEbookInfo(Page page) {
      ...
      //@TODO 要将从文字用提取数字
        ...
        try {
            ...
            //System.out.println("Description 为NULL");
        }
        try {
            ...
            //System.out.println("PopularAnnotations 为NULL");
        }
        try {
